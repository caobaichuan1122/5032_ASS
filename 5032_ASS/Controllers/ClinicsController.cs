...
namespace _5032_ASS.Controllers
{
    public class ClinicsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Clinic_Name,Clinic_Phone,Clinic_Lat,Clinic_Lng,Clinic_Rating,Clinic_Description")] Clinic clinic)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Clinic_Name,Clinic_Phone,Clinic_Lat,Clinic_Lng,Clinic_Rating,Clinic_Description")] Clinic clinic)
        {
            if (ModelState.IsValid)
            {
